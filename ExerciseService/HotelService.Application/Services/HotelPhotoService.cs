    ...
    : IHotelPhotoService
{
    ...
    public async Task<HotelPhotoDto> GetFirstHotelPhotoByIdAsync(Guid hotelId, CancellationToken ct)
    {
    ...
    public async Task<string> AddHotelPhotoAsync(AddHotelPhotoRequest hotelPhoto, Guid hotelId, CancellationToken ct)
    {
        ...
        var hotelRecord = hotelPhoto.ToHotelPhoto(key);
    ...
    public async Task<bool> DeleteHotelPhotosByHotelIdAsync(Guid hotelId, CancellationToken ct)
    {
        ...
        return await hotelPhotoRepository.DeleteByHotelIdAsync(hotelId, ct);
    }
}