    ...
    : IHotelCommentService
{
    ...
    public async Task<bool> DeleteHotelCommentsByHotelIdAsync(Guid hotelId, CancellationToken ct)
    {
        return await hotelCommentRepository.DeleteByHotelIdAsync(hotelId, ct) ? true :
